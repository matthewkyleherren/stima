  ...
  [3, 59, 65],
  {
    ...
    608: function (e, t, r) {
      ...
      var v = {
        ...
        "press-releases": {
          imageKey: "pressReleasesHeaderImageUrl",
          themeKey: "pressReleasesTheme",
          fields: {},
        },
        insights: {
          imageKey: "insightsHeaderImageUrl",
          themeKey: "insightsTheme",
          fields: {},
        },
        "in-the-news": {
          imageKey: "inTheNewsHeaderImageUrl",
          themeKey: "inTheNewsTheme",
          fields: {},
        },
        resources: {
          imageKey: "pressKitHeaderImageUrl",
        ...
        computed: c(
          ...
          {},
          {
            ...
            heroImageUrl: function () {
              var e, t;
              return null === (e = this.newsPage) || void 0 === e
                ? void 0
                : e[
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (t.next = 2),
                        e.$store.dispatch("content/fetchNewsPage")
                      );
                    case 2:
                    case "end":
                      return t.stop();
